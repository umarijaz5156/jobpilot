                ...
                <div class="tw-p-5">
                    ...
                    <div class="tw-flex tw-justify-between tw-items-center tw-mb-4">
                        ...
                        <p class="tw-text-sm tw-text-[#767F8C] tw-mb-0">Max:
                            {{ $currency_symbol }}<span>{{ round($maxSalary, 0) }}</span></p>
                    </div>
                    <div class="tw-flex tw-gap-2 tw-items-center tw-py-2">
                        <input {{ request('price_min') == 10 && request('price_max') == 100 ? 'checked' : '' }}
                            onclick="changeSalary(10, 100)" type="radio" id="10" class="tw-scale-125"
                            name="salleryRange">
                        <label for="10" class="tw-text-sm tw-text-[#18191C] tw-mt-[2px]">{{ $currency_symbol }}10
                            -
                            {{ $currency_symbol }}100</label>
                    </div>
                    <div class="tw-flex tw-gap-2 tw-items-center tw-py-2">
                        <input {{ request('price_min') == 100 && request('price_max') == 1000 ? 'checked' : '' }}
                            ...
                            name="salleryRange">
                        <label for="100"
                            class="tw-text-sm tw-text-[#18191C] tw-mt-[2px]">{{ $currency_symbol }}100
                            -
                            {{ $currency_symbol }}1,000</label>
                    </div>
                    <div class="tw-flex tw-gap-2 tw-items-center tw-py-2">
                        <input {{ request('price_min') == 1000 && request('price_max') == 10000 ? 'checked' : '' }}
                            ...
                            name="salleryRange">
                        <label for="1000"
                            class="tw-text-sm tw-text-[#18191C] tw-mt-[2px]">{{ $currency_symbol }}1,000 -
                            {{ $currency_symbol }}10,000</label>
                    </div>
                    <div class="tw-flex tw-gap-2 tw-items-center tw-py-2">
                        <input {{ request('price_min') == 10000 && request('price_max') == 100000 ? 'checked' : '' }}
                            ...
                            name="salleryRange">
                        <label for="10000"
                            class="tw-text-sm tw-text-[#18191C] tw-mt-[2px]">{{ $currency_symbol }}10,000 -
                            {{ $currency_symbol }}100,000</label>
                    </div>
                    <div class="tw-flex tw-gap-2 tw-items-center tw-py-2">
