                        ...
                        <table id="my-table" class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $job->social_media_clicks_through }}</td>
                                    <td class="text-center">{{ $job->aggregates_clicks_through }}</td>
                                    <td class="text-center">{{ $job->website_reads }}</td>
                                    <td class="text-center">{{  $job->website_clicks_through }}</td>
